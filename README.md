...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/quaternionic-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/quaternionic-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add quaternionic
# for installing globally
pixi global install quaternionic
```
...
It is possible to list all of the versions of `quaternionic` available on your platform:
...
```
pixi search quaternionic --channel conda-forge
```
